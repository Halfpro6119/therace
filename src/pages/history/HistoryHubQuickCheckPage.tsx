            ...
            <div className="space-y-2">
              {item.options.map((opt) => (
                <button
                  ...
                  className={`w-full text-left rounded-lg border px-4 py-2 text-sm transition ${answer === opt ? 'ring-2 ring-amber-500' : ''}`}
          ...
          {item.type === 'trueFalse' && (
            <div className="flex gap-2 mt-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg border text-sm transition ${answer === 'true' ? 'ring-2 ring-amber-500' : ''}`}
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg border text-sm transition ${answer === 'false' ? 'ring-2 ring-amber-500' : ''}`}
