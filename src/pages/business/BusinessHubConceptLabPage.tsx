      ...
      {!selectedConcept ? (
          ...
          {concepts.length === 0 && (
            <div className="rounded-xl p-6 border text-center" style={{ background: 'rgb(var(--surface))', borderColor: 'rgb(var(--border))' }}>
              ...
              <button
                type="button"
                onClick={() => navigate(`/business-hub/unit/${unit.id}`)}
                className="text-sm font-medium px-4 py-2 rounded-lg bg-amber-500/20 text-amber-700 dark:text-amber-400"
              >
                Back to Unit {unit.id}
              </button>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="rounded-lg p-4 bg-amber-500/10 border border-amber-500/30 flex gap-2">
