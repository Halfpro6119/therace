...
import { ChevronLeft, Lightbulb, BookOpen, Target, FileText, Calculator, MessageSquare, ChevronRight, List, Lock, Zap, FileQuestion, GraduationCap } from 'lucide-react';
...
export function BusinessHubUnitPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {/* Test yourself — exam-style practice */}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: 'rgb(var(--text-secondary))' }}>Browse topics, Case Study & Evaluation</p>
            </div>
            <ChevronRight size={20} className="flex-shrink-0 ml-auto" style={{ color: 'rgb(var(--text-secondary))' }} />
          </motion.button>
        </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm" style={{ color: 'rgb(var(--text-secondary))' }}>
          Build recall before and after tests.
        </p>
        <div className="grid gap-4 sm:grid-cols-2">
          <motion.button
            type="button"
