...
export const GOLDEN_TOPIC_SPECS: GoldenTopicSpec[] = [
  ...
  topic('f1-graphs-geometry', 'Graphs & Geometry', 'foundation', 1, 'F1-18', 'F1-26'),
  ...
  topic('f3-mixed', 'Foundation Paper 3 (mixed)', 'foundation', 3, 'F3-01', 'F3-08'),
...
export const GOLDEN_UNIT_SPECS: GoldenUnitSpec[] = [
  ...
  unit('f1-coordinates-tables-angles', 'Coordinates, tables, angles, shape, probability, stats', 'f1-graphs-geometry', 'F1-18', 'F1-26'),
