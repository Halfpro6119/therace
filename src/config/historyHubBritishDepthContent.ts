...
export const BRITISH_BA_TIMELINE: TimelineEvent[] = [
  ...
  { id: 'B-BA-1-1066', optionKey: BD_BA, partId: 'B-BA-1', date: '14 October 1066', title: 'Battle of Hastings', description: 'William defeated Harold. Harold killed. Norman conquest began.', order: 2 },
  { id: 'B-BA-1-1069', optionKey: BD_BA, partId: 'B-BA-1', date: '1069', title: 'Harrying of the North', description: 'William brutally suppressed rebellion. Land laid waste.', order: 3 },
  { id: 'B-BA-2-1086', optionKey: BD_BA, partId: 'B-BA-2', date: '1086', title: 'Domesday Book', description: 'Survey of land and resources. Basis for taxation and control.', order: 4 },
  { id: 'B-BA-3-1070s', optionKey: BD_BA, partId: 'B-BA-3', date: '1070s', title: 'Lanfranc and Church reform', description: 'Norman Archbishop reformed English Church. New cathedrals.', order: 5 },
];
...
export const BRITISH_BA_KEY_TERMS: HistoryKeyTerm[] = [
  ...
  { id: 'B-BA-kt3', optionKey: BD_BA, partId: 'B-BA-2', term: 'Domesday Book', definition: '1086 survey of land and resources.', dateOrContext: '1086' },
  { id: 'B-BA-kt4', optionKey: BD_BA, partId: 'B-BA-2', term: 'Feudalism', definition: 'System of landholding and obligations; King, lords, knights, peasants.', dateOrContext: 'Norman' },
  { id: 'B-BA-kt5', optionKey: BD_BA, partId: 'B-BA-3', term: 'Lanfranc', definition: 'Norman Archbishop of Canterbury; reformed Church.', dateOrContext: '1070s' },
];
...
export const BRITISH_BA_QUICK_CHECKS: HistoryQuickCheckItem[] = [
  ...
  { id: 'B-BA-qc2', optionKey: BD_BA, partId: 'B-BA-2', type: 'shortAnswer', question: 'What was the Domesday Book?', correctAnswer: 'Survey of land', feedback: { correct: 'Correct.', incorrect: 'A survey of land and resources (1086).' } },
];
...
export const BRITISH_BB_TIMELINE: TimelineEvent[] = [
  ...
  { id: 'B-BB-1-1295', optionKey: BD_BB, partId: 'B-BB-1', date: '1295', title: 'Model Parliament', description: 'Included knights and burgesses. Representation of community.', order: 2 },
  { id: 'B-BB-3-1277', optionKey: BD_BB, partId: 'B-BB-3', date: '1277', title: 'First Welsh War', description: 'Edward conquered Wales. Built castles.', order: 3 },
  { id: 'B-BB-3-1296', optionKey: BD_BB, partId: 'B-BB-3', date: '1296', title: 'Conquest of Scotland', description: 'Edward took Stone of Destiny. Wars with Scotland.', order: 4 },
  { id: 'B-BB-3-1297', optionKey: BD_BB, partId: 'B-BB-3', date: '1297', title: 'Battle of Stirling Bridge', description: 'William Wallace defeated English. Scottish resistance.', order: 5 },
];
...
export const BRITISH_BB_KEY_TERMS: HistoryKeyTerm[] = [
  ...
  { id: 'B-BB-kt3', optionKey: BD_BB, partId: 'B-BB-3', term: 'William Wallace', definition: 'Scottish resistance leader; Stirling Bridge.', dateOrContext: '1297' },
  { id: 'B-BB-kt4', optionKey: BD_BB, partId: 'B-BB-3', term: 'Caernarfon Castle', definition: 'Edward\'s castle in Wales; symbol of conquest.', dateOrContext: '1283' },
];
...
export const BRITISH_BC_TIMELINE: TimelineEvent[] = [
  ...
  { id: 'B-BC-2-1588', optionKey: BD_BC, partId: 'B-BC-2', date: '1588', title: 'Spanish Armada', description: 'Philip II sent fleet to invade. Defeated by weather and English fireships.', order: 3 },
  { id: 'B-BC-2-1590s', optionKey: BD_BC, partId: 'B-BC-2', date: '1590s', title: 'Theatre and culture', description: 'Shakespeare, Globe Theatre. Golden age of drama.', order: 4 },
];
...
export const BRITISH_BC_KEY_TERMS: HistoryKeyTerm[] = [
  ...
  { id: 'B-BC-kt2', optionKey: BD_BC, partId: 'B-BC-2', term: 'Spanish Armada', definition: '1588; Philip II\'s invasion attempt; defeated.', dateOrContext: '1588' },
  { id: 'B-BC-kt3', optionKey: BD_BC, partId: 'B-BC-2', term: 'Globe Theatre', definition: 'Shakespeare\'s theatre; Elizabethan culture.', dateOrContext: '1599' },
];

export const BRITISH_BC_CONCEPT_CARDS: HistoryConceptCard[] = [
  { id: 'B-BC-cc1', optionKey: BD_BC, partId: 'B-BC-2', prompt: 'Why did the Spanish Armada fail?', conceptType: 'cause', modelAnswer: 'English fireships; Spanish formation broken. Weather (storms). Length of voyage; supplies. English tactics. Spanish aims too ambitious.' },
];

export const BRITISH_BC_QUICK_CHECKS: HistoryQuickCheckItem[] = [
  { id: 'B-BC-qc1', optionKey: BD_BC, partId: 'B-BC-2', type: 'multipleChoice', question: 'In which year was the Spanish Armada?', options: ['1586', '1588', '1590', '1592'], correctAnswer: '1588', feedback: { correct: 'Correct.', incorrect: '1588.' } },
];
...
export const BRITISH_BD_CONCEPT_CARDS: HistoryConceptCard[] = [
  { id: 'B-BD-cc1', optionKey: BD_BD, partId: 'B-BD-2', prompt: 'How did the Great Fire change London?', conceptType: 'consequence', modelAnswer: 'Destruction; rebuilding. Wren\'s new churches and St Paul\'s. Wider streets; brick. But also hardship; slow recovery for poor.' },
];
