...
const H1: GoldenMathsQuestion[] = [
  ...
  { id: 'H1-39', prompt: 'Solve x² = 4 graphically', type: 'graphRead', paper: 1, tier: 'higher', calculator: false, diagram: 'coordinateGrid', answers: '2,-2', diagramParams: { templateId: 'math.graphs.quadratic_linear.v1', values: { quadraticCoeff: 1, linearGradient: 0, linearIntercept: 4, xMin: -5, xMax: 5, yMin: -1, yMax: 5 }, visibility: { showQuadratic: true, showLinear: true, showIntersectionPoints: true } } },
  ...
  { id: 'H1-53', prompt: 'Find the perimeter of a compound shape', type: 'numeric', paper: 1, tier: 'higher', calculator: false, diagram: 'compoundShape', answers: '28', diagramParams: { values: { width1: 8, height1: 4, width2: 4, height2: 6 } } },
  ...
  { id: 'H1-56', prompt: 'In a right-angled triangle the two shorter sides are 3 cm and 4 cm. Find the length of the hypotenuse using Pythagoras.', type: 'numeric', paper: 1, tier: 'higher', calculator: false, diagram: 'triangle', answers: '5', diagramParams: { values: { sideAB: 3, sideBC: 4, sideAC: 5 }, visibility: { showSideAC: false } } },
  { id: 'H1-57', prompt: 'The diagram shows a right-angled triangle. The hypotenuse is 5 cm and one shorter side is 3 cm. Use Pythagoras\' theorem to find the length of the other shorter side. Give your answer in cm.', type: 'numeric', paper: 1, tier: 'higher', calculator: false, diagram: 'triangle', answers: '4', diagramParams: { values: { sideAB: 5, sideBC: 3, sideAC: 4 }, visibility: { showSideAC: false } } },
...
const H2: GoldenMathsQuestion[] = [
  ...
  { id: 'H2-51', prompt: 'In a right-angled triangle the two shorter sides are 5 cm and 12 cm. Find the length of the hypotenuse (Pythagoras)', type: 'numeric', paper: 2, tier: 'higher', calculator: true, diagram: 'triangle', answers: '13', diagramParams: { values: { sideAB: 13, sideBC: 12, sideAC: 5 }, visibility: { showSideAB: false } } },
  { id: 'H2-52', prompt: 'In a right-angled triangle the hypotenuse is 10 cm and one shorter side is 6 cm. Find the other shorter side using Pythagoras', type: 'numeric', paper: 2, tier: 'higher', calculator: true, diagram: 'triangle', answers: '8', diagramParams: { values: { sideAB: 10, sideBC: 8, sideAC: 6 }, visibility: { showSideBC: false } } },
