...
export const HEALTH_QUICK_CHECKS: HealthQuickCheck[] = [
  ...
  // Content plan expansion — Units 3–4 toward 80+ quick checks
  { id: 'q-3.1-5', unitId: '3', topicId: '3.1', type: 'multipleChoice', question: 'What does holistic health include?', options: ['Only physical', 'Physical, mental and social', 'Only mental', 'Only disease'], correctAnswer: 'Physical, mental and social', feedback: { correct: 'Correct.', incorrect: 'Holistic = physical, mental and social wellbeing.' } },
  { id: 'q-3.2-6', unitId: '3', topicId: '3.2', type: 'shortAnswer', question: 'What do we call factors that increase the chance of illness?', correctAnswer: 'Risk factors', feedback: { correct: 'Correct.', incorrect: 'Risk factors (e.g. smoking, poor diet).' } },
  { id: 'q-3.2-7', unitId: '3', topicId: '3.2', type: 'shortAnswer', question: 'What do we call factors that reduce the chance of illness?', correctAnswer: 'Protective factors', feedback: { correct: 'Correct.', incorrect: 'Protective factors (e.g. exercise, social support).' } },
  { id: 'q-3.3-5', unitId: '3', topicId: '3.3', type: 'trueFalse', question: 'Heart rate is an indicator of cardiovascular health.', options: ['True', 'False'], correctAnswer: 'True', feedback: { correct: 'Correct.', incorrect: 'Heart rate indicates cardiovascular fitness.' } },
  { id: 'q-3.4-5', unitId: '3', topicId: '3.4', type: 'multipleChoice', question: 'What is evaluation in health promotion?', options: ['Ignoring results', 'Assessing if the intervention worked', 'Only planning', 'Only delivery'], correctAnswer: 'Assessing if the intervention worked', feedback: { correct: 'Correct.', incorrect: 'Evaluation = assessing effectiveness.' } },
  { id: 'q-3.4-6', unitId: '3', topicId: '3.4', type: 'shortAnswer', question: 'Who is the target audience in health promotion?', correctAnswer: 'The group it is aimed at', feedback: { correct: 'Correct.', incorrect: 'Target audience = group the promotion is aimed at.' } },
  { id: 'q-4.1-3', unitId: '4', topicId: '4.1', type: 'multipleChoice', question: 'What is care planning?', options: ['Ignoring needs', 'Identifying needs and how to meet them', 'Only medical care', 'Only physical care'], correctAnswer: 'Identifying needs and how to meet them', feedback: { correct: 'Correct.', incorrect: 'Care planning = identifying needs and meeting them.' } },
  { id: 'q-4.2-5', unitId: '4', topicId: '4.2', type: 'trueFalse', question: 'Person-centred care puts the individual at the centre of decisions.', options: ['True', 'False'], correctAnswer: 'True', feedback: { correct: 'Correct.', incorrect: 'Person-centred = individual at centre.' } },
  { id: 'q-4.3-3', unitId: '4', topicId: '4.3', type: 'shortAnswer', question: 'What can care workers support to improve self-concept?', correctAnswer: 'Self-esteem', feedback: { correct: 'Correct. Or positive identity.', incorrect: 'Self-esteem and positive identity.' } },
  { id: 'q-4.4-3', unitId: '4', topicId: '4.4', type: 'multipleChoice', question: 'What is behaviour support in health promotion?', options: ['One-off advice', 'Ongoing help to change unhealthy habits', 'Ignoring habits', 'Only medication'], correctAnswer: 'Ongoing help to change unhealthy habits', feedback: { correct: 'Correct.', incorrect: 'Behaviour support = ongoing, not one-off.' } },
  { id: 'q-3.2-8', unitId: '3', topicId: '3.2', type: 'multipleChoice', question: 'Health inequality refers to:', options: ['Same health for everyone', 'Differences in health outcomes between groups', 'Only physical health', 'Only mental health'], correctAnswer: 'Differences in health outcomes between groups', feedback: { correct: 'Correct.', incorrect: 'Health inequality = differences by income, area, etc.' } },
  { id: 'q-4.2-6', unitId: '4', topicId: '4.2', type: 'shortAnswer', question: 'What must consent be for it to be valid? (two words)', correctAnswer: 'Informed voluntary', feedback: { correct: 'Correct.', incorrect: 'Informed and voluntary.' } },
];
