...
export const GCSE_SCOPE_SUBJECTS: GcseSubjectDef[] = [
  ...
  },
  {
    ...
    examBoard: 'Edexcel',
    description: 'Level 2 GCSE / FSMQ-style Further Mathematics',
    icon: '📐',
    themeColor: '#6366F1',
    papers: [
      { paperNumber: 1, name: 'Paper 1 (Algebra, functions, graphs)', calculatorAllowedDefault: true },
      { paperNumber: 2, name: 'Paper 2 (Calculus intro, matrices, vectors)', calculatorAllowedDefault: true },
    ],
  },
  // —— Sciences ——
  {
  ...
  },
  {
    ...
    tierMode: 'single',
    examBoard: 'AQA',
    description: 'GCSE Economics',
    icon: '📊',
    themeColor: '#A855F7',
    papers: [
      { paperNumber: 1, name: 'Paper 1 (Microeconomics)', calculatorAllowedDefault: true },
      { paperNumber: 2, name: 'Paper 2 (Macroeconomics)', calculatorAllowedDefault: true },
    ],
  },
  {
    slug: 'psychology',
