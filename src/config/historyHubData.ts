...
const GERMANY_KEY_TERMS: HistoryKeyTerm[] = [
  ...
  { id: 'AB-kt20', optionKey: PERIOD_AB, partId: 'AB-1', term: 'Freikorps', definition: 'Right-wing paramilitary groups; crushed Spartacists; tried Kapp Putsch.', dateOrContext: '1919–1920' },
  { id: 'AB-kt21', optionKey: PERIOD_AB, partId: 'AB-1', term: 'Mein Kampf', definition: 'Hitler\'s book outlining Nazi ideology; written in prison after Munich Putsch.', dateOrContext: '1925' },
  { id: 'AB-kt22', optionKey: PERIOD_AB, partId: 'AB-2', term: 'Article 48', definition: 'Weimar constitution allowed President to rule by decree in emergency; undermined democracy.', dateOrContext: 'Weimar' },
  { id: 'AB-kt23', optionKey: PERIOD_AB, partId: 'AB-2', term: 'Reichstag Fire Decree', definition: '1933 emergency decree suspending civil liberties after Reichstag fire.', dateOrContext: '1933' },
  { id: 'AB-kt24', optionKey: PERIOD_AB, partId: 'AB-3', term: 'Hitler Youth', definition: 'Nazi organisation for boys; indoctrination and military training.', dateOrContext: '1930s' },
  { id: 'AB-kt25', optionKey: PERIOD_AB, partId: 'AB-3', term: 'Kinder, Küche, Kirche', definition: 'Nazi ideal for women: children, kitchen, church.', dateOrContext: '1930s' },
];
...
const GERMANY_CONCEPT_CARDS: HistoryConceptCard[] = [
  ...
  { id: 'AB-cc5', optionKey: PERIOD_AB, partId: 'AB-1', prompt: 'How significant was the Treaty of Versailles in causing problems for the Weimar Republic?', conceptType: 'significance', modelAnswer: 'Very significant: war guilt, reparations, territorial losses created economic and political problems; many blamed Weimar for signing. But other factors mattered: constitution, political extremism, Wall Street Crash. Versailles was important but not the only cause.' },
  { id: 'AB-cc6', optionKey: PERIOD_AB, partId: 'AB-2', prompt: 'What were the similarities and differences between the Spartacist Uprising and the Kapp Putsch?', conceptType: 'similarity', modelAnswer: 'Similar: both challenged Weimar; both failed. Different: Spartacists were left-wing (communist), Kapp was right-wing; Spartacists crushed by Freikorps, Kapp failed when workers went on strike; Spartacists wanted revolution, Kapp wanted to restore old order.' },
  { id: 'AB-cc7', optionKey: PERIOD_AB, partId: 'AB-3', prompt: 'What were the consequences of Nazi policies for women and young people?', conceptType: 'consequence', modelAnswer: 'Women: encouraged to stay home, have children (Kinder, Küche, Kirche); lost jobs. Young people: Hitler Youth/League of German Maidens; indoctrination, physical training; education controlled. Both: conformity, loss of freedom, but some benefits (e.g. employment for women during war).' },
];
...
const GERMANY_QUICK_CHECKS: HistoryQuickCheckItem[] = [
  ...
  { id: 'AB-qc9', optionKey: PERIOD_AB, partId: 'AB-1', type: 'trueFalse', question: 'The Dawes Plan reduced Germany\'s reparations payments.', correctAnswer: 'true', feedback: { correct: 'Correct.', incorrect: 'The Dawes Plan (1924) rescheduled and reduced annual payments.' } },
  { id: 'AB-qc10', optionKey: PERIOD_AB, partId: 'AB-1', type: 'multipleChoice', question: 'Who led the Spartacist Uprising?', options: ['Hitler', 'Luxemburg and Liebknecht', 'Kapp', 'Stresemann'], correctAnswer: 'Luxemburg and Liebknecht', feedback: { correct: 'Correct.', incorrect: 'Rosa Luxemburg and Karl Liebknecht led the Spartacists.' } },
  { id: 'AB-qc11', optionKey: PERIOD_AB, partId: 'AB-2', type: 'shortAnswer', question: 'What was the Reichstag Fire Decree?', correctAnswer: 'Emergency decree suspending civil liberties', feedback: { correct: 'Correct.', incorrect: 'The decree suspended civil liberties and allowed arrest without trial.' } },
  { id: 'AB-qc12', optionKey: PERIOD_AB, partId: 'AB-3', type: 'multipleChoice', question: 'What did the Nuremberg Laws do?', options: ['Banned the Nazi Party', 'Stripped Jews of citizenship', 'Created the Gestapo', 'Abolished the SA'], correctAnswer: 'Stripped Jews of citizenship', feedback: { correct: 'Correct.', incorrect: 'The Nuremberg Laws (1935) stripped Jews of citizenship.' } },
];
